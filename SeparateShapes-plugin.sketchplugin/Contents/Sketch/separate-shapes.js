...
var separate = function separate(context) {
  ...
  if (selection.count() == 2) {
    var separatedShapeGroups = [].concat.apply([], [shapeGroupFromOp(selection[1], selection[0], ops.SUBTRACT), shapeGroupFromOp(selection[0], selection[1], ops.SUBTRACT), shapeGroupFromOp(selection[0], selection[1], ops.INTERSECT)].filter(function (layer) {
      return layer;
    }));
